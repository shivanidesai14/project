...
<center><a href="userinsert.php"><input type="button" value="Insert" class="btn btn-success btn-lg"></a>&nbsp&nbsp&nbsp<input type="submit" value="Delete All" class="btn btn-danger btn-lg"></a></center>
</form>
</body>
</html>