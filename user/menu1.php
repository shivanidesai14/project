...
<form method="post" action="search.php" >
  <div class="navbar-inner">
    <a class="brand" href="loginmainpage.php"><img src="themes/images/logo.png"  alt="Bootsshop"/></a>
    ...
    <ul id="topMenu" class="nav pull-right">
	 <li class=""><a href="viewprofile.php">View Profile</a></li> 
	 <li class=""><a href="contact.php">Contact</a></li>
	  <li><a href="cartdisplay.php"><span class="glyphicon glyphicon-shopping-cart"></span>Cart</a></li>
